...
var audio_manager_path: String = "res://global/audio_manager.tscn" ## The path to the audio manager scene.
var audio_manage_scene: PackedScene = load(audio_manager_path) ## Loads the audio manage scene so the tool can modify it.
var folder_path: String = "res://assets/sound" ## The path to your folder containing your SoundEffectSetting resources.
...
func _run() -> void:
	...
	if modified == true:
		...
		print("AudioManager was not updated, no new SoundEffectSetting resources found.")
